...
public class QLSParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("QLS");
  ...
  { 
    QLSParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = QLSParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = QLSParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(QLSParseControllerGenerated.class);
    }
  ...
  { 
    return QLSParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
