package org.spoofax.lang.lwc.ql.analysis;
...
public class QLParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("QL");
  ...
  { 
    QLParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = QLParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = QLParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(QLParseControllerGenerated.class);
    }
  ...
  { 
    return QLParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
